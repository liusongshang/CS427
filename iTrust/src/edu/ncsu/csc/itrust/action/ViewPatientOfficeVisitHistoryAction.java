...
public class ViewPatientOfficeVisitHistoryAction {
	 ...
	 * @throws ITrustException
	 */
	private void process_PreOfficeVisits() throws ITrustException {
		try {
			List<PatientBean> plist = patientDAO.getAll_PreRegistered_Patients();
...
/**
 * Get the list of pre_registered patients an HCP has had office visits with
 * 
 * @return the list of patients an HCP has had office visits with
 * @throws DBException
 */
	public List<PatientVisitBean> get_PreRegistered_Patients() throws DBException {
		
		try {
			process_PreOfficeVisits();
		}
		catch (ITrustException ie) {
			//TODO
		}
