...
public class ViewSleepEntryAction implements ViewEntryAction {
     ...
     *
     * @return boolean representing whether the patient or HCP is logged in 
     */
    public boolean isPatientOrHCPLoggedIn(long patientMID) throws ITrustException {
            try {
	...
	public List<SleepEntryBean> getDiary(long patientMID)
		...
		try {
            boolean loggedIn = isPatientOrHCPLoggedIn(patientMID);
			if (loggedIn) {
