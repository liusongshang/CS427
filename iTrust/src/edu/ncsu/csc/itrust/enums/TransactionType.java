...
public enum TransactionType {
	...
	/**PATIENT_PREREGISTER*/
	PATIENT_PREREGISTER(104, "User preregistered as a patient", "preregistered a patient", false),
	/**PRE_REGISTERED_ACTIVATE*/
	PRE_REGISTERED_ACTIVATE(105,"Activate preregistered patient","Activated as patient",true),
	/**PRE_REGISTERED_DEACTIVATE*/
	PRE_REGISTERED_DEACTIVATE(106,"Deactivate pregistered patient","Deactivated as patient",true),
	/**LHCP_CREATE*/
	LHCP_CREATE(200, "Create a LHCP", "created an LHCP", false),
	/**LHCP_EDIT*/
	LHCP_EDIT(201, "Edit LHCP information", "edited LHCP information", false),
	/**LHCP_DISABLE*/
	LHCP_DISABLE(202, "Disable a LHCP", "disabled an LHCP", false),
	/**ER_CREATE*/
	...
	/**VIEW_COD_STATISTICS**/
	VIEW_COD_TRENDS(8700, "View Cause of Death Trends", "View Cause of Death Trends", false),

	VIEW_TRANSACTION_LOGS(8800, "View Transaction Logs", "View Transaction Logs", false),

	/**EDIT_CURRENT_HEALTH_INFORMATION**/
	EDIT_CURRENT_HEALTH_INFORMATION(8900, "Edit Current Health Information", "Edit Current Health Information", false),
	;
