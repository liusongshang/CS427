...
<br>
<p><b>Message:</b> </p>
<textarea class="form-control" rows="3" name="messageBody"><%= StringEscapeUtils.escapeHtml(request.getParameter("messageBody")==null?"":request.getParameter("messageBody")) %></textarea><br />
<br />
<br>
<p><b>Please check the recipient above is your intended recipient. If so, please type 'confirm' below and send.</b></p>
<input name="send_confirmation" type="text" pattern="confirm" required>
<br/>
