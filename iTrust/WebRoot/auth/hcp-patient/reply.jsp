...
<%
	...
	if (session.getAttribute("message") != null) {
		...
		if (request.getParameter("messageBody") != null) {
			if (request.getParameter("messageBody").length() > 1000) {
				%>
					<p><b>The character count for the message body exceeds 1000. Please shorten your message to meet this cap or send two messages.</b></p>

				<%
				lengthUnder1000 = false;
			}
			else {
