...
<%
	...
	if(representee!=null && !representee.equals("")) {
		patientID = Long.valueOf(representee);
	}
	...
	<h4>
		<tr>
			...
			<table>
                                <tr>
                                <td><b>To:</b></td>
                                <td style="width: 80%; border: 1px solid Gray;">
                                        <input name="UID_repID" value="" type="hidden">
                                        <span id="NAME_repID" name="NAME_repID"> <%= StringEscapeUtils.escapeHtml("" + ( action.getPatientName(patientID))  ) %> </span>
                                </td>
                                        <td>
                                                <%@include file="/util/getUserFrame.jsp" %>
                                                <input type="button" onclick="getUser('repID');" value="Choose a different recipient." >
                                        </td>
                                </tr>
                        </table>
                </td>
