...
if ("healthRecordForm".equals(submittedFormName)) {
    ...
    try {
		...
		healthHistory.addOVHealthRecord(Long.parseLong(pidString), new BeanBuilder<HealthRecordForm>().build(request.getParameterMap(), new HealthRecordForm()), ovaction.getOvID());
        updateMessage = "Health information successfully updated.";
        recordAdded = true;
