...
<%@page import="edu.ncsu.csc.itrust.action.PreRegisterAction" %>
...
<%
    ...
    PreRegisterAction preRegisterAction = (PreRegisterAction) session.getAttribute("preRegisterAction");

    if (preRegisterAction == null) {
        preRegisterAction = new PreRegisterAction(prodDAO);
        session.setAttribute("preRegisterAction", preRegisterAction);
    }
    ...
    try {
        ...
        if (userRole == null) {
            if (request.isUserInRole("patient")) {
                userRole = "patient";
            } else if (request.isUserInRole("preregistered")) {
                userRole = "preregistered";
