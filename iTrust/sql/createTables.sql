...
CREATE TABLE users(
	...
	openID              VARCHAR(200),
	Role                enum('patient','admin','hcp','uap','er','tester','pha', 'lt', 'preregistered','hidden') NOT NULL DEFAULT 'admin',
...
CREATE TABLE personalhealthinformation (
  HealthRecordNumber int(10) unsigned auto_increment,
	PatientID BIGINT unsigned NOT NULL default '0',
	...
	BMI float default '-1',
  EditReason varchar(1023) default '',
