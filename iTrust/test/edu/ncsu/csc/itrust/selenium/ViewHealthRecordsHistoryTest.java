...
public class ViewHealthRecordsHistoryTest extends iTrustSeleniumTest {
	...
	public void testOfficeVisit4MonthOldViewHealthMetrics() throws Exception{
	    ...
	    //Verify adult health record table displays
  		...
  		//Patient length
  		assertEquals("22.3in", entriesToCheck.get(2).getText());
  		//Patient weight
  		assertEquals("16.5lbs", entriesToCheck.get(3).getText());
  		//Patient head circumference
  		assertEquals("16.1in", entriesToCheck.get(5).getText());
  		//Patient household smoking status
  		assertEquals("Non-smoking household", entriesToCheck.get(6).getText());
	}
	...
	public void testOfficeVisit20YrOldViewHealthMetrics() throws Exception{
		...
		//Patient length
		assertEquals("62.3in", row1.get(2).getText());
		//Patient weight
		assertEquals("124.3lbs", row1.get(3).getText());
		//Patient BMI
		assertEquals("22.51", row1.get(4).getText());
		//Weight status
		assertEquals("Normal", row1.get(5).getText());
		//Patient blood pressure
		assertEquals("100/75 mmHg", row1.get(6).getText());
		//Patient smoking status
		assertEquals("N", row1.get(7).getText());
		//Patient household smoking status
		assertEquals("Non-smoking household", row1.get(8).getText());
		//Patient HDL levels
		assertEquals("65 mg/dL", row1.get(9).getText());
		//Patient LDL levels
		assertEquals("102 mg/dL", row1.get(10).getText());
		//Patient triglycerides
		assertEquals("147 mg/dL", row1.get(11).getText());
		...
		//Patient length
		assertEquals("62.3in", row2.get(2).getText());
		//Patient weight
		assertEquals("120.7lbs", row2.get(3).getText());
		//Patient BMI
		assertEquals("21.86",row2.get(4).getText());
		//Weight status
		assertEquals("N/A", row2.get(5).getText());
		//Patient blood pressure
		assertEquals("107/72 mmHg", row2.get(6).getText());
		//Patient smoking status
		assertEquals("Y", row2.get(7).getText());
		//Patient household smoking status
		assertEquals("Indoor smokers", row2.get(8).getText());
		//Patient HDL levels
		assertEquals("63 mg/dL", row2.get(9).getText());
		//Patient LDL levels
		assertEquals("103 mg/dL", row2.get(10).getText());
		//Patient triglycerides
		assertEquals("145 mg/dL", row2.get(11).getText());
				
		//Row 3 values
		//Office visit date
		assertEquals("10/10/2011", row3.get(0).getText());
		//Patient length
		assertEquals("62.3in", row3.get(2).getText());
		//Patient weight
		assertEquals("121.3lbs", row3.get(3).getText());
		//Patient BMI
		assertEquals("21.97", row3.get(4).getText());
		//Weight status
		assertEquals("N/A", row3.get(5).getText());
		//Patient head circumference
		assertEquals("105/73 mmHg", row3.get(6).getText());
		//Patient smoking status
		assertEquals("Y", row3.get(7).getText());
		//Patient household smoking status
		assertEquals("Indoor smokers", row3.get(8).getText());
		//Patient HDL levels
		assertEquals("64 mg/dL", row3.get(9).getText());
		//Patient LDL levels
		assertEquals("102 mg/dL", row3.get(10).getText());
		//Patient triglycerides
		assertEquals("143 mg/dL", row3.get(11).getText());
	}
	...
	public void testDeletedHealthRecord() throws Exception{
		...
		//Patient length
		assertEquals("72.0in", row1.get(2).getText());
		//Patient weight
		assertEquals("185.0lbs", row1.get(3).getText());
		//Patient BMI
		assertEquals("25.09", row1.get(4).getText());
		//Weight status
		assertEquals("Overweight", row1.get(5).getText());
		//Patient blood pressure
		assertEquals("107/104 mmHg", row1.get(6).getText());
		//Patient smoking status
		assertEquals("N", row1.get(7).getText());
		//Patient household smoking status
		assertEquals("Non-smoking household", row1.get(8).getText());
		//Patient HDL levels
		assertEquals("41 mg/dL", row1.get(9).getText());
		//Patient LDL levels
		assertEquals("104 mg/dL", row1.get(10).getText());
		//Patient triglycerides
		assertEquals("101 mg/dL", row1.get(11).getText());
		//By personnel Kelly Doctor
		assertEquals("Kelly Doctor", row1.get(14).getText());
	}
	...
	public void testOfficeVisitDateIsBirthDate() throws Exception{
		...
		//Patient length
		assertEquals("42.8in", row1.get(2).getText());
		//Patient weight
		assertEquals("41.2lbs", row1.get(3).getText());
		//Patient blood pressure
		assertEquals("123/64 mmHg", row1.get(5).getText());
		//Patient household smoking status
		assertEquals("Non-smoking household", row1.get(6).getText());
	}
	...
	public void testViewHealthMetricsByHCP() throws Exception{
		...
		//Patient length
		assertEquals("34.7in", infantRow1.get(2).getText());
		//Patient weight
		assertEquals("30.2lbs", infantRow1.get(3).getText());
		//Patient head circumference
		assertEquals("19.4in", infantRow1.get(5).getText());
		//Patient household smoking status
		assertEquals("Indoor smokers", infantRow1.get(6).getText());
		
		//Row 2 values
		//Office visit date
		assertEquals("02/02/2012", infantRow2.get(0).getText());
		//Patient length
		assertEquals("25.7in", infantRow2.get(2).getText());
		//Patient weight
		assertEquals("15.8lbs", infantRow2.get(3).getText());
		//Patient head circumference
		assertEquals("17.1in", infantRow2.get(5).getText());
		//Patient household smoking status
		assertEquals("Indoor smokers", infantRow2.get(6).getText());
		
		//Row 3 values
		//Office visit date
		assertEquals("12/01/2011", infantRow3.get(0).getText());
		//Patient length
		assertEquals("22.5in", infantRow3.get(2).getText());
		//Patient weight
		assertEquals("12.1lbs", infantRow3.get(3).getText());
		//Patient head circumference
		assertEquals("16.3in", infantRow3.get(5).getText());
		//Patient household smoking status
		assertEquals("Indoor smokers", infantRow3.get(6).getText());
		
		//Row 4 values
		//Office visit date
		assertEquals("11/01/2011", infantRow4.get(0).getText());
		//Patient length
		assertEquals("21.1in", infantRow4.get(2).getText());
		//Patient weight
		assertEquals("10.3lbs", infantRow4.get(3).getText());
		//Patient head circumference
		assertEquals("15.3in", infantRow4.get(5).getText());
		//Patient household smoking status
		assertEquals("Indoor smokers", infantRow4.get(6).getText());
		
		//Row 5 values
		//Office visit date
		assertEquals("10/01/2011", infantRow5.get(0).getText());
		//Patient length
		assertEquals("19.6in", infantRow5.get(2).getText());
		//Patient weight
		assertEquals("8.3lbs", infantRow5.get(3).getText());
		//Patient head circumference
		assertEquals("14.5in", infantRow5.get(5).getText());
		//Patient household smoking status
		assertEquals("Indoor smokers", infantRow5.get(6).getText());
	}
	...
	public void testOfficeVisit5YrOldViewHealthMetrics() throws Exception{
		...
		//Patient length
		assertEquals("42.9in", youthRow1.get(2).getText());
		//Patient weight
		assertEquals("37.9lbs", youthRow1.get(3).getText());
		//Patient blood pressure
		assertEquals("95/65 mmHg", youthRow1.get(5).getText());
		//Patient household smoking status
		assertEquals("Outdoor smokers", youthRow1.get(6).getText());
		
		//Row 2 youth values
		//Office visit date
		assertEquals("10/15/2012", youthRow2.get(0).getText());
		//Patient length
		assertEquals("41.3in", youthRow2.get(2).getText());
		//Patient weight
		assertEquals("35.8lbs", youthRow2.get(3).getText());
		//Patient blood pressure
		assertEquals("95/65 mmHg", youthRow2.get(5).getText());
		//Patient household smoking status
		assertEquals("Indoor smokers", youthRow2.get(6).getText());
		...
		//Patient length
		assertEquals("39.3in", infantRow1.get(2).getText());
		//Patient weight
		assertEquals("36.5lbs", infantRow1.get(3).getText());
		//Patient head circumference
		assertEquals("19.9in", infantRow1.get(5).getText());
		//Patient household smoking status
		assertEquals("Indoor smokers", infantRow1.get(6).getText());
	}
