...
public class BMICalculationTest extends iTrustSeleniumTest {
	...
	public void testUnderweightEC() throws Exception {
		...
		cell = driver.findElement(By.xpath("//table[@id='HealthRecordsTable']/tbody/tr[5]/td[6]"));
		...
		//Patient Weight Status
		cell = driver.findElement(By.xpath("//table[@id='HealthRecordsTable']/tbody/tr[4]/td[6]"));
		assertEquals("Underweight", cell.getText());
		...
		//Patient Weight Status
		cell = driver.findElement(By.xpath("//table[@id='HealthRecordsTable']/tbody/tr[3]/td[6]"));
		assertEquals("Underweight", cell.getText());
