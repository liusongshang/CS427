...
public class LoginTest extends iTrustSeleniumTest {
	...
	public void testResetPassword() throws Exception {
		...
		assertEquals("iTrust - Login", wd.getTitle());
		...
		// Select "Patient" from the drop-down list and enter "1" in the 'MID' field
		Select dropdown = new Select(wd.findElement(By.name("role")));
		dropdown.selectByValue("patient");
		...
		// Enter "blue" in the 'answer' field and "newPw12345" in the 'New Password' field
