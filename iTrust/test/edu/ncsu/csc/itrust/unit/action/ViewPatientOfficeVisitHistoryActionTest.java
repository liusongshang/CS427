...
public class ViewPatientOfficeVisitHistoryActionTest extends TestCase{
	...
	public void testGetPatients() throws Exception {
		...
		assertEquals("31", list.get(22).getLastOVDateD());
		assertEquals("03", list.get(22).getLastOVDateM());
	}

	/**
	 * testprocessPreOfficeVisits
	 * @throws Exception
	 */
	public void testprocessPreOfficeVisits() throws Exception {
		List<PatientVisitBean> patientVisits = action.get_PreRegistered_Patients();
