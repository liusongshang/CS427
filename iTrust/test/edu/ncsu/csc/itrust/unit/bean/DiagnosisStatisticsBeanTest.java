...
public class DiagnosisStatisticsBeanTest extends TestCase {
	...
	public void testAll() throws Exception {
		DiagnosisStatisticsBean dsBean = new DiagnosisStatisticsBean("12346", 1, 6, 2, 5);
		assertEquals("12346", dsBean.getZipCode());
		assertEquals(1, dsBean.getZipStats());
		assertEquals(6, dsBean.getRegionStats());
		assertEquals(2, dsBean.getStateStats());
		assertEquals(5, dsBean.getOverallStats());
	}
